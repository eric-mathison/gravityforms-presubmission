<?php
/*
Plugin Name:  Gravity Forms Pre-Submission Confirmation
Plugin URI:   https://mathisonmedia.com
Description:  Pre-Submission Confirmation Support for Gravity Forms
Version:      1.0.0
...
class EMPreConfirmation {
    ...
    */
    ...
    public static function preview_replace_variables( $content, $form ) {
        ...
        add_filter('gform_merge_tag_filter', array('EMPreConfirmation', 'preview_special_merge_tags'), 10, 4);
        ...
        remove_filter('gform_merge_tag_filter', array('EMPreConfirmation', 'preview_special_merge_tags'));
